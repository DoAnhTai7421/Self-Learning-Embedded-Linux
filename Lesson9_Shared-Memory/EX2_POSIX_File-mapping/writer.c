...
#define FILE_NAME           "Astatine_mmap"     /* name of the shared memory object */
...
{ 
    ...
    strcpy(data, "MMAP Hello Astatine !");
     ...
     * @return
     */ 
    // shm_unlink(FILE_NAME); // Không nên unlink trước khi reader đọc dữ liệu vì sẽ xảy ra lỗi No such file or Directory
